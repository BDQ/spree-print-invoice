...
desc 'Generate documentation for the print_invoice extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PrintInvoiceExtension'
...
desc 'Test the print_invoice extension.'
...
namespace :test do
  desc 'Functional test the print_invoice extension.'
  ...
  desc 'Unit test the print_invoice extension.'
